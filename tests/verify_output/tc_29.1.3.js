...
//Begin Test
casper.test.begin("Executing R code in Markdown Cell", 6, function suite(test) {
	...
	casper.wait(5000).then(function(){
		this.waitForSelector(x(".//*[@id='part1.md']/div[3]/div[2]"), function (){
			console.log("output has produced");
		});
		this.test.assertSelectorHasText(x(".//*[@id='part1.md']/div[3]/div[2]"), input, 'The R cell executed successfully and shows the code as it is in output');
	});
