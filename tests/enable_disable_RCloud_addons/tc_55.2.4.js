casper.test.begin("Enable multiple extension from 'Eable Extensions' field", 6, function suite(test) {
    ...
    casper.then(function (){
        var q = this.fetchText(x(".//*[@id='settings-body']/div[4]/label/input"));
