/*
 Author: Prateek
 Description: After a notebook belonging to some other user is forked, it gets added in the 'My Notebooks' list as starred with count=1. 
 * The user can view all the previous history versions of that notebook by clicking the 'history' icon present on the side of the Notebook's name
 */
