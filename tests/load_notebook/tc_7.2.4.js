 ...
 * The GitHub URL will refer to some deleted notebook belonging to the same user
 */

//Begin Test
casper.test.begin("Using GitHub URL of some deleted notebook(same user)", 6, function suite(test) {
    ...
    casper.then(function () {
		console.log('Deleting the current loaded Notebook');
    ...
    casper.then(function () {
        ...
        this.test.assertEquals(Notebook_id, Notebook_id1, "Using GitHub URL of some deleted notebook (same user) is opened");
    });
