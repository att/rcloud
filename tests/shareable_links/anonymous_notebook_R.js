...
casper.test.begin("Notebook.R notebook opening as a Anonymous user", 5, function suite(test) {
    ...
    casper.thenOpen("http://127.0.0.1:8080/notebook.R/224e1bd73049268fe01d", function () {
        this.wait(5000);
        this.test.assertUrlMatch("http://127.0.0.1:8080/notebook.R/224e1bd73049268fe01d");
