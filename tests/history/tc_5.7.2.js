 ...
 *Load the previous versions of the notebook by selecting the respective history links
 */

//Begin Tests

casper.test.begin("Viewing History links/Loading history link of a notebook", 12, function suite(test) {
