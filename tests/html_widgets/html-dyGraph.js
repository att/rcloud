/*
 Author: Prateek 
 Description: Check whether the dygraph output is visible in output div
 */

//Begin Test
casper.test.begin("Checking for dygraph html widget in outpuyt div", 6, function suite(test) {
    ...
    casper.wait(6000).then(function (){
        ...
        casper.withFrame(0,function() {
            // this.test.assertSelectorHasText(".dygraph-label", "New Haven Temperatures");
            this.test.assertVisible(".rcloud-htmlwidget")
