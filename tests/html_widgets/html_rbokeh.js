/*
 Author: Prateek 
 Description: Check whether the rbokeh html widget's output is visible in output div
 */

//Begin Test
casper.test.begin("Check whether the rbokeh html widget's output is visible in output div", 6, function suite(test) {
