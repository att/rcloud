/*
 Author: Prateek
 Description:    This is a casperjs automated test script for showning that, Line numbers for a markdown code should be visible for a cell in executing mode
 */
