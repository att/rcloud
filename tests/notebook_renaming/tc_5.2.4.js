/* 
 Author: Arko
 Description:    This is a casperjs automated test script to enter only special characters(e.g- ^,&,#,@) while changing the 
 title a given notebook
 */

//Begin Tests

casper.test.begin(" Notebook rename:Special characters", 4, function suite(test) {
