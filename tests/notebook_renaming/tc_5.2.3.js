/* 
 Author: Arko
 Description:    This is a casperjs automated test script to enter alphabets and numbers while changing the title a given notebook
 */

//Begin Tests

casper.test.begin(" Notebook rename:Alpha-numeric", 4, function suite(test) {
