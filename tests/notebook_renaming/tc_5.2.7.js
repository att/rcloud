/* 
 Author: Arko
 Description:    This is a casperjs automated test script to enter alphabets,numbers and special characters(e.g- ^,&,#,@) while changing the 
 title a given notebook
 */

//Begin Tests

casper.test.begin(" Notebook rename:Alphabets,numbers and special characters", 4, function suite(test) {
