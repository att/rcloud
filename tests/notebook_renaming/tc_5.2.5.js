/* 
 Author: Arko
 Description:    This is a casperjs automated test script to enter both alphabets(A-Z, a-z) and special characters(e.g- ^,&,#,@) while changing the 
 title a given notebook
 */

//Begin Tests

casper.test.begin(" Notebook rename:Alphabets and special characters", 4, function suite(test) {
    ...
    casper.viewport(1024, 768).then(function () {
        ...
        var z = casper.evaluate(function triggerKeyDownEvent() {
            jQuery("#notebook-title").text("A#@uy&");
