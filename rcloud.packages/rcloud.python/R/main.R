...
#'  
PYTHON_PATH='rcloud.python.path'
PYTHON_EXTRA_LIBS='python.extra.libs'
JUPYTER_CELL_TIMEOUT='jupyter.cell.timeout'
...
.start.jupyter.adapter <- function(rcloud.session)
{
  ...
  sys$path <- c(sys$path, system.file("python", package="rcloud.python"))
