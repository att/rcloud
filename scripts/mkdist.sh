...
## need abs path
ADST=`cd "$DST"; pwd`
mkdir -p "$DST/rcloud/packages/src/contrib"
mkdir "$DST/tmp"
...
( cd "$DST"; tar fcz rcloud-$BRANCH-$REV.tar.gz rcloud )
