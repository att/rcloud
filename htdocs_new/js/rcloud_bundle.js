...
RCloud.create = function(rcloud_ocaps) {
    ...
    function setup_authenticated_ocaps() {
        ...
        rcloud.custom_search = function(qry){
			var res;
			function createListOfSearchReasults(d){
				q=qry;
				d = JSON.parse(d);
				...
				$("#custom-search-result").html(tableContent);
			}
			rcloud_ocaps.custom_search(qry, createListOfSearchReasults);
			return res;
		};
		/*---------------------------------------END-----------------------------------*/		
        ...
        rcloud.create_notebook = function(content, k) {
			alert("rcb:328 : creating notebook...");
